...
// Civilization descriptions (from API /racewar/get_map/{seq}/2)
const CIV_DESC: Record<string, string> = {
  '1': '宇宙中具有生命的低等文明，没有思想与意识，无法思考自我，很难突破二维束缚。存在的意义像是上帝造物为了丰富宇宙的多元性，生若蝼蚁，命若草芥。无法探索到生存危机，只能依靠本能去应对灾难。如果说春蚕文明的存在还有其它意义，那只有一个——存在即奉献，春蚕到死丝方尽，蜡烛成灰泪始干。',
  '2': '宇宙中存活不多的单点式文明，拥有极其稀缺的量子大脑，潜能无限，算力极强。但只有极少数人类意识到这种能力，并创造了"图灵梦境"这样的世界。地球文明的发展具有不确定性，既有爆发式的幂指数增长能力，也会陷入停滞甚至返祖现象。',
  '3': '宇宙中分布式文明的代表，已初步迈入高等文明门槛，经历了六次文明的更迭和进化。前五次进化都因人数到达阀值时毁灭，文明得以保存，"一个大脑"得以延续。第六次进化中因触犯负熵诅咒而彻底毁灭，在毁灭之际将"一个大脑"藏于四维空间，后被地球文明发现。',
  '4': '六域文明分别为：海洋文明、时间文明、六体文明、爬虫文明、元素文明、死亡文明。各有特点，皆属高等文明，科技高度发达，都拥有星际探险的能力。它们曾处在宇宙丝绸之路的支线上，但目睹"清理"工作后未接入。最终都因触犯负熵诅咒而被直接清理。',
  '5': '宇宙丝绸之路的创建者之一，也是现存丝绸之路的唯一管理者。本身属于宏观文明，但具有量子化和无视时空等微观特点，与量子文明有相似之处。正因如此，在曾经的宇宙清理中幸存下来，被量子文明驯服成宇宙丝绸之路的管理者。',
  '6': '宇宙丝绸之路计划的发起者，也是创建者之一。分布式文明的杰出代表，也是宇宙中最伟大的文明之一。最早提出建设宇宙丝绸之路，以透明、开源、去中心化方式重构宇宙文明图景。在丝绸之路建成后被推举为"51%管理者"，但以"拒绝扮演任何角色"为由拒绝了。',
  '7': '已知宇宙中最古老的文明，伴随宇宙大爆炸（三秒内）诞生，属于原生态微观文明，形态为量子态。后被量子文明发起"果壳行动"禁锢在夸克之中，即夸克禁闭，无法与外界联系。三秒文明后被人类从夸克禁闭中解救，走上寻找宇宙终极定律的漫漫长路。',
  '8': '宇宙大爆炸50亿年之后，与量子文明同时代成长起来的宏观文明，独立于"宇宙丝绸之路"外的强大文明。最先意识到宇宙必然走向寂灭的命运，以行星为原子构建自己的宏观世界，一直往宇宙更深处进行探索，寻找解救宇宙寂灭之道。',
  '9': '宇宙大爆炸50亿年之后发展起来的超级文明，曾属宏观文明，通过反向进化转变为微观文明，赢得与三秒文明的果壳战争，成为宇宙文明的顶级存在。意识到无解的"熵+"定律后，建立潘多拉法则，一边发展算力文明，一边收割文明算力，希望积蓄算力计算出"爱因斯坦-罗森桥之路"，为跳出宇宙做准备。',
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-lg rounded-xl overflow-hidden border border-white/15 shadow-2xl max-h-[90vh] overflow-y-auto"
        ...
        <div className="p-4 space-y-4">
          ...
          {CIV_DESC[map.lv] && (
            <div>
              <div className="text-xs font-mono text-white/25 mb-1.5">文明简介</div>
              <p className="text-xs font-mono text-white/60 leading-relaxed">{CIV_DESC[map.lv]}</p>
            </div>
          )}
